...
if __name__ == '__main__':
    real_dir = '/data/lpr_vht_hnc_v4/train'
    synth_dir = '/data/lpr_vht_hnc_v4/synth'
    dst_file = '/data/lpr_vht_hnc_v4/train.txt'
    create_label_file(real_dir, synth_dir, dst_file)

    real_dir = '/data/lpr_vht_hnc_v4/validate'
    synth_dir = None
    dst_file = '/data/lpr_vht_hnc_v4/val.txt'
    create_label_file(real_dir, synth_dir, dst_file)
